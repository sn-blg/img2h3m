...
mod tests {
    ...
    fn find_object_templates_signature_test() {
        let raw_map = [
            0x00u8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x41, 0x56,
            0x57, 0x6D, 0x72, 0x6E, 0x64, 0x30, 0x2E, 0x64, 0x65, 0x66, 0xFF, 0xFF, 0xFF, 0xFF,
            0xFF, 0xFF, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x41, 0x56, 0x57,
            0x6D, 0x72, 0x6E, 0x64, 0x30, 0x2E, 0x64, 0x65, 0x66, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
            0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xFF, 0x00, 0x01, 0x00, 0x47, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x41,
            0x56, 0x4C, 0x68, 0x6F, 0x6C, 0x67, 0x30, 0x2E, 0x64, 0x65, 0x66, 0xFF, 0xFF, 0xFF,
            0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];

        let objects_templates_offset = find_object_templates_offset(&raw_map);

        assert!(objects_templates_offset.is_ok());
        assert_eq!(objects_templates_offset.unwrap(), 31);
    }
}
